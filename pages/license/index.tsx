            ...
            <DefaultLayout>
                <div className="license_container">
                    ...
                    <div className="license_session">
                        ...
                        <p className="license_session_lorem">All images used in the WhiteCollar Webflow Template are licensed for free personal and commercial use. If you'd like to use any specific image, you can check the licenses and download the images for free on Unsplash, Pexels.</p>
